from domeniu.tranzactie import creeaza_tranzactie
from infrastructura.repository_tranzactii import adauga_tranzactie_cont, numar_tranzactii_cont, modifica_tranzactie, \
    get_all_tranzactii_cont, sterge_tranzactie_dupa_zi, sterge_tranzactie_dupa_perioada, sterge_tranzactie_dupa_tip, \
...
#1.
def adauga_tranzactie_service(cont, id_tranzactie, zi_tranzactie, suma_tranzactie, tip_tranzactie):
    '''
    ...
    adauga_tranzactie_cont(cont, tranzactie)
...
def modifica_tranzactie_service(cont, id_tranzactie, zi_tranzactie, suma_tranzactie, tip_tranzactie):
    '''
    ...
    tranzactie = creeaza_tranzactie(id_tranzactie, zi_tranzactie, suma_tranzactie, tip_tranzactie)
    valideaza_tranzactie(tranzactie)
    modifica_tranzactie(cont, tranzactie)

#2.
def sterge_tranzactie_dupa_zi_service(cont, ziua_cautata):
    sterge_tranzactie_dupa_zi(cont, ziua_cautata)

def sterge_tranzactie_dupa_perioada_service(cont, zi_inceput, zi_sfarsit):
    sterge_tranzactie_dupa_perioada(cont, zi_inceput, zi_sfarsit)

def sterge_tranzactie_dupa_tip_service(cont, tip_de_sters):
    sterge_tranzactie_dupa_tip(cont, tip_de_sters)
