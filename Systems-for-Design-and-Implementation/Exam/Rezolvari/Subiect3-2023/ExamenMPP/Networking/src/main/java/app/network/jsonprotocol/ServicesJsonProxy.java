...
public class ServicesJsonProxy implements IServices {
    ...
    public ConfigurationWord addConfigurationWord(ConfigurationWord configurationWord) throws AppException {
        Request request = JsonProtocolUtils.createAddConfigurationWordRequest(configurationWord);
        sendRequest(request);
        Response response = readResponse();
        if (response.getType() == ResponseType.ERROR) {
            String err = response.getErrorMessage();
        ...
        return response.getConfigurationWord();
    }
    ...
    public List<Word> getAllWords() throws AppException {
        Request request = JsonProtocolUtils.createGetAllWordsRequest();
        sendRequest(request);
        Response response = readResponse();
        if (response.getType() == ResponseType.ERROR) {
            String err = response.getErrorMessage();
