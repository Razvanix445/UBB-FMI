...
public class TransportServicesRpcProxy implements ITransportServices {
    ...
    public void login(ReservationManager reservationManager, ITransportObserver client) throws TransportException {
    ...
    public void addReservation(Reservation reservation) throws TransportException {
    ...
    public List<Reservation> getReservationsByTrip(Long tripId) throws TransportException {
        Request req = new Request.Builder().type(RequestType.GET_RESERVATIONS_BY_TRIP).data(tripId).build();
        sendRequest(req);
        Response response = readResponse();
        if (response.type() == ResponseType.ERROR){
            String err = response.data().toString();
    ...
    public List<Seat> getSeatsByTripId(Long tripId) throws TransportException {
    ...
    public void logout(ReservationManager reservationManager, ITransportObserver client) throws TransportException {
