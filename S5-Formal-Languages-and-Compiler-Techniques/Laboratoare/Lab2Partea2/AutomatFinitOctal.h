...
#ifndef LAB2PARTEA2_AUTOMATFINITOCTAL_H
#define LAB2PARTEA2_AUTOMATFINITOCTAL_H
...
class AutomatFinitOctal {
public:
    set<string> states = {"q0", "q1", "q2", "q3", "q4", "q5"};
    set<char> alphabet = {'0', '1', '2', '3', '4', '5', '6', '7', 'u', 'U', 'l', 'L', 'z', 'Z'};
...
#endif //LAB2PARTEA2_AUTOMATFINITOCTAL_H
