...
constexpr int Optiune_Golire_Cos_Inchirieri = 9;
constexpr int Optiune_Umple_Random_Cos_Inchirieri = 10;
constexpr int Optiune_Afisare_Cos_Inchirieri = 11;
constexpr int Optiune_Exportare_In_Fisier_CSV = 12;
constexpr int Optiune_Undo = 13;
...
void UI::ruleaza() {
	...
	*/
	while (true) {
		...
		cout << "9. Goleste cosul de inchirieri.\n";
		cout << "10.Adauga un numar de filme aleatoare in cosul de inchirieri.\n";
		cout << "11.Afiseaza cosul de inchirieri.\n";
		cout << "12.Exporta cosul in fisier CSV / HTML.\n";
		cout << "13.Undo.\n";
