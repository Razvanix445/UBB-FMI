from business.service_tranzactii import adauga_tranzactie_service, numar_tranzactii_service, \
    ...
    tipareste_suma_mari_zile_mici_service, tipareste_sume_mari_service, tipareste_dupa_tip_service, undo
...
def ruleaza_calculeaza_sold():
    ...
    assert ui_calculeaza_sold(lista, 1) == 0.0
...
def ruleaza_toate_testele():
    ...
    #ruleaza_undo()
    print("Teste undo trecute cu succes!\n")