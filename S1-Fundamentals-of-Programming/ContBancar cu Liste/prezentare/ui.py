...
def ui_adauga_tranzactie(cont, undolist):
...
def ui_modifica_tranzactie(cont, undolist):
    id = int(input("Introduceti id-ul tranzactiei: "))
    zi = int(input("Introduceti ziua in care a fost facuta tranzactia: "))
    suma = float(input("Introduceti suma tranzactiei: "))
    tip = input("Introduceti tipul tranzactiei: ")
...
def ui_sterge_tranzactie_dupa_zi(cont, undolist):
...
def ui_sterge_tranzactie_dupa_perioada(cont, undolist):
...
def ui_sterge_tranzactie_dupa_tip(cont, undolist):
...
def meniu_filtre(cont, undolist):
    while True:
        comenzi = {
...
def ui_undo(cont, undolist):
    undo(cont, undolist)
    print("Operatie efectuata cu succes!\n")
    #assert(str(ve) == "Nu exista tranzactii in lista!\n")
