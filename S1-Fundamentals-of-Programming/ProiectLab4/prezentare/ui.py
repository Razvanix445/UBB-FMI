from business.cont import elimin_mai_mici, elimina_tip, sortare_tranzactii_tip, sold, suma_tip, sterge_perioada, \
    sterge_tip, sterge_zi, ui_citeste_lista, adaugare_lista, update_lista, afis
    ...
    while semafor == True:
        ...
        try:
            ...
            if cmd == 0:
                ...
                print("Introduceti ziua, suma si tipul noului element")
                zi = int(input("ziua: "))
                suma = int(input("suma: "))
                tip = input("tipul: ")
                if (tip == tipul[0] or tip == tipul[1]):
...
'''
    semafor = True
    options = {1: meniu_adaugare, 2: meniu_stergere, 3: meniu_afisari, 4: meniu_rapoarte, 5: meniu_filtre}
    while semafor == True:
        print(menu)
        try:
            cmd = int(input("Optiunea: "))
