...
public class Main {
    public static void main(String[] args) {
        ...
        FriendshipDBPagingRepository prietenieDBPagingRepository = new FriendshipDBPagingRepository(url, username, password);
        MessageDBPagingRepository messageDBPagingRepository = new MessageDBPagingRepository(url, username, password);
        FriendRequestDBRepository friendRequestDBRepository = new FriendRequestDBRepository(url, username, password);
        Service service = new Service(userDBPagingRepository, prietenieDBPagingRepository, messageDBPagingRepository, friendRequestDBRepository);
...
//        UI.ui(service);
        ...
        //List<Utilizator> friends = service.getPrieteniUtilizator(13L);
        //Page<Message> friends = messageDBPagingRepository.findAll(pageable);
        //System.out.println(friends.getContent().count());
    }
