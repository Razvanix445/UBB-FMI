...
public class LoginController {
    ...
    private void handleLogin() {
        ...
        if (isValidCredentials(username, password)) {
            Session.setLoggedUser(service.cautaUtilizatorDupaUsername(username));
            openMainCrudWindow();
        } else {
    ...
    private boolean isValidCredentials(String username, String password) {
        try {
            ...
            boolean isCorrectPassword = service.isCorrectPassword(username, password);
            if (!isCorrectPassword || password.isEmpty()) {
